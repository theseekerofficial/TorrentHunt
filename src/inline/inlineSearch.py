                    ...
                    if 'error' not in results:
                        ...
                        for count, item in enumerate(results['data'][offset:]):
                            ...
                            if botId == '1700458114' and 'magnet' in item:
                                ...
                                markup = telebot.types.InlineKeyboardMarkup()
                                markup.add(telebot.types.InlineKeyboardButton(text=language['joinChannelBtn'][userLanguage], url='https://t.me/the_seeker_s_cave'), telebot.types.InlineKeyboardButton(text=language['joinDiscussionBtn'][userLanguage], url='https://t.me/Master_Torrenz_s_Cave'))
